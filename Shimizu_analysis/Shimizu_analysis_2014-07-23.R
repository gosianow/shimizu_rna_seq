...
write.table(data.frame(SI_id=rownames(d.cpm), d.cpm), "_Data/new_data_16Jun/data_cpm.xls", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)

write.table(data.frame(SI_id=rownames(d.cpm.l), d.cpm.l), "_Data/new_data_16Jun/data_cpm_log.xls", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
