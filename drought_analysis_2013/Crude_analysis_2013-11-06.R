...
# get table of counts
ch <- as.character(read.table("Data/new_data_18Oct/raw_data.csv", sep=";",nrow=1,stringsAsFactors=FALSE)[1,-c(1,2,57)])
x <- read.table("Data/new_data_18Oct/raw_data.csv", sep=";",skip=3, header=F, row.names=1)
nc <- ncol(x)
x <- x[,-c(1)]
...
pdf("Crude_analysis/NEW_mds3_500.pdf",w=10,h=10)
...
pdf("Crude_analysis/NEW_mds3_1000.pdf",w=10,h=10)
